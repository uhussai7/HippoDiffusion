...
[grad_dev_phit_phi_utvtwt_final_nii, grad_dev_phit_phi_utvtwt_notfinal_distortion_nii, grad_dev_phit_phi_utvtwt_notfinal_distortion_scalar_nii, grad_dev_phit_phi_utvtwt_notfinal_distortion_diag_scalar_nii] =FinalizeGradDevAndDistortion(grad_dev_phit_utvtwt_nii,grad_dev_phi_utvtwt_nii,0,2);
save_nii(grad_dev_phit_phi_utvtwt_notfinal_distortion_nii,sprintf('..\\Diffusion\\%s\\anat\\Reparam\\%s\\grad_dev_notfinal_distortion.nii.gz',subject,LR));
save_nii(grad_dev_phit_phi_utvtwt_notfinal_distortion_scalar_nii,sprintf('..\\Diffusion\\%s\\anat\\Reparam\\%s\\grad_dev_notfinal_distortion_scalar.nii.gz',subject,LR));
save_nii(grad_dev_phit_phi_utvtwt_notfinal_distortion_diag_scalar_nii,sprintf('..\\Diffusion\\%s\\anat\\Reparam\\%s\\grad_dev_notfinal_distortion_diag_scalar.nii.gz',subject,LR));
